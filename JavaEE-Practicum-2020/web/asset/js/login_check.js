...
$().ready(function() {
    ...
    username.on("focus", null, {promptObj: usernamePrompt}, clearError);
    password.on("focus", null, {promptObj: passwordPrompt}, clearError);
    ...
    // 密码不能为空;
    password.on("blur", null, {index: 0}, function(event) {
        let index = event.data.index;
    ...
    captcha.on("blur", null, {captcha: captcha, captchaPrompt: captchaPrompt}, captchaOnBlur);
